import { ReactElement, MouseEvent, MouseEventHandler, TouchEvent, CSSProperties } from 'react';
...
export interface ISelectorMethods {
    onMouseDown?: (annotation: IAnnotation | undefined, e: MouseEvent, options: SelectorMethodsOptions) => IAnnotation | undefined;
    onMouseUp?: (annotation: IAnnotation | undefined, e: MouseEvent, options: SelectorMethodsOptions) => IAnnotation | undefined;
    onMouseMove?: (annotation: IAnnotation | undefined, e: MouseEvent, options: SelectorMethodsOptions) => IAnnotation | undefined;
    onTouchStart?: (annotation: IAnnotation | undefined, e: TouchEvent, options: SelectorMethodsOptions) => IAnnotation | undefined;
    onTouchEnd?: (annotation: IAnnotation | undefined, e: TouchEvent, options: SelectorMethodsOptions) => IAnnotation | undefined;
    onTouchMove?: (annotation: IAnnotation | undefined, e: TouchEvent, options: SelectorMethodsOptions) => IAnnotation | undefined;
    onClick?: (annotation: IAnnotation | undefined, e: any, options: SelectorMethodsOptions) => IAnnotation | undefined;
}
export interface ISelector {
    ...
    intersects: ({ x, y }: {
        x: number;
        y: number;
    }, geometry: IGeometry, container: {
        width: number;
        height: number;
    }) => boolean;
    area: (geometry: IGeometry, container: {
        width: number;
        height: number;
    }) => number;
...
export declare enum AllowedShape {
    Oval = "Oval",
    Point = "Point",
    Rectangle = "Rectangle"
}
...
export interface ToolBarOptions {
    ...
    renderSelectedAnnotationIcons?: (props: RenderSelectedAnnotationIconsProps) => ReactElement | null;
}
...
export interface AnnotationProps {
    ...
    onAnnotationClick: (annotation: IAnnotation) => void;
    onSelectedAnnotationUpdate: (annotation: IAnnotation, selected: boolean) => void;
