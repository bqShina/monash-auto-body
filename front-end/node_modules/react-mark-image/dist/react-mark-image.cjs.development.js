...
})(exports.AllowedShape || (exports.AllowedShape = {}));
...
var withRelativeMousePos = function withRelativeMousePos(key) {
  ...
  return function (DecoratedComponent) {
    ...
    }(React.Component); // WithRelativeMousePos.displayName = `withRelativeMousePos(${DecoratedComponent.displayName})`;
...
var Inner = /*#__PURE__*/styled__default.div(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  padding: 8px 16px;\n\n  textarea {\n    border: 0;\n    font-size: 14px;\n    margin: 6px 0;\n    min-height: 60px;\n    outline: 0;\n  }\n"])));
var Button = /*#__PURE__*/styled__default.div(_templateObject2 || (_templateObject2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background: whitesmoke;\n  border: 0;\n  box-sizing: border-box;\n  color: #363636;\n  cursor: pointer;\n  font-size: 1rem;\n  margin: 0;\n  outline: 0;\n  padding: 8px 16px;\n  text-align: center;\n  text-shadow: 0 1px 0 rgba(0, 0, 0, 0.1);\n  width: 100%;\n\n  transition: background 0.21s ease-in-out;\n\n  &:focus,\n  &:hover {\n    background: #eeeeee;\n  }\n"])));
...
var fadeInScale = /*#__PURE__*/styled.keyframes(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  from {\n    opacity: 0;\n    transform: scale(0);\n  }\n\n  to {\n    opacity: 1;\n    transform: scale(1);\n  }\n"])));
var Container = /*#__PURE__*/styled__default.div(_templateObject2$1 || (_templateObject2$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background: white;\n  border-radius: 2px;\n  box-shadow: 0 1px 5px 0 rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14),\n    0 3px 1px -2px rgba(0, 0, 0, 0.12);\n  margin-top: 16px;\n  transform-origin: top left;\n\n  animation: ", " 0.31s cubic-bezier(0.175, 0.885, 0.32, 1.275);\n  overflow: hidden;\n  z-index: 2;\n"])), fadeInScale);
...
function pointerDown(annotation, e, options, type) {
  ...
  if (!selection) {
    ...
    return {
      ...
      selection: {
        mode: exports.SelectionMode.New,
        anchorX: anchorX,
        anchorY: anchorY
      },
      data: {
...
function pointerUp(annotation, _e, editorMode) {
  if (annotation != null && annotation.selection) {
    ...
    if (!geometry || annotation.selection.mode === exports.SelectionMode.New) {
      return;
    }

    switch (annotation.selection.mode) {
      case exports.SelectionMode.Selecting:
        return _extends({}, annotation, {
          selection: _extends({}, annotation.selection, {
            mode: editorMode === exports.EditorMode.AnnotateOnly ? exports.SelectionMode.Final : exports.SelectionMode.Editing
          })
        });
    }
  }
...
function pointerMove(annotation, e) {
  ...
  if ((annotation == null ? void 0 : (_annotation$selection = annotation.selection) == null ? void 0 : _annotation$selection.mode) === exports.SelectionMode.New || (annotation == null ? void 0 : (_annotation$selection2 = annotation.selection) == null ? void 0 : _annotation$selection2.mode) === exports.SelectionMode.Selecting) {
    ...
    return _extends({}, annotation, {
      selection: _extends({}, annotation == null ? void 0 : annotation.selection, {
        mode: exports.SelectionMode.Selecting
      }),
...
var TYPE = exports.AllowedShape.Rectangle;
...
var TYPE$1 = exports.AllowedShape.Point;
...
var methods$1 = {
  onClick: function onClick(annotation, e, options) {
    if (!(annotation != null && annotation.geometry)) {
      return _extends({}, annotation, {
        selection: {
          mode: exports.SelectionMode.Final
        },
...
var TYPE$2 = exports.AllowedShape.Oval;
...
var Container$1 = /*#__PURE__*/styled__default.div(_templateObject$2 || (_templateObject$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background: white;\n  border-radius: 2px;\n  box-shadow: 0 1px 5px 0 rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14),\n    0 3px 1px -2px rgba(0, 0, 0, 0.12);\n  padding: 8px 16px;\n  margin-top: 8px;\n  margin-left: 8px;\n  z-index: 2;\n"])));
...
var Overlay = /*#__PURE__*/styled__default.div(_templateObject$3 || (_templateObject$3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background: rgba(0, 0, 0, 0.4);\n  border-radius: 5px;\n  bottom: 4px;\n  color: white;\n  font-size: 12px;\n  font-weight: bold;\n  opacity: 0;\n  padding: 10px;\n  pointer-events: none;\n  position: absolute;\n  right: 4px;\n  transition: opacity 0.21s ease-in-out;\n  user-select: none;\n"])));
...
var withShapeWrapper = function withShapeWrapper(DecoratedShape) {
  var WrappedComponent = function WrappedComponent(props) {
    ...
    var shouldShowContent = editorMode === exports.EditorMode.AnnotateWithText && mouseHovered && renderContent;
...
var Container$2 = /*#__PURE__*/styled__default.div(_templateObject$4 || (_templateObject$4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  border-radius: 100%;\n  box-shadow: 0 0 2px 2px white inset;\n  box-sizing: border-box;\n  transition: box-shadow 0.21s ease-in-out;\n  z-index: ", ";\n  cursor: ", ";\n"])), function (_ref) {
...
function Oval(props) {
  ...
  var isReadOnly = editorMode === exports.EditorMode.ReadOnly;
  if (!geometry) return null;
...
var Container$3 = /*#__PURE__*/styled__default.div(_templateObject$5 || (_templateObject$5 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  border-radius: 50%;\n  box-sizing: border-box;\n  // prettier-ignore\n  box-shadow: \n          0 0 0 1px rgba(0, 0, 0, 0.3),\n          0 0 0 2px rgba(0, 0, 0, 0.2),\n          0 5px 4px rgba(0, 0, 0, 0.4);\n  height: 16px;\n  position: absolute;\n  transform: translate3d(-50%, -50%, 0);\n  width: 16px;\n  z-index: ", ";\n  cursor: ", ";\n"])), function (_ref) {
  var isReadOnly = _ref.isReadOnly;
  return (isReadOnly ? 0 : 1) + ";";
}, function (_ref2) {
  var isReadOnly = _ref2.isReadOnly;
...
var Container$4 = /*#__PURE__*/styled__default.div(_templateObject$6 || (_templateObject$6 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  box-shadow: 0 0 2px 2px white inset;\n  box-sizing: border-box;\n  transition: box-shadow 0.21s ease-in-out;\n  z-index: ", ";\n  cursor: ", ";\n"])), function (_ref) {
  var isReadOnly = _ref.isReadOnly;
  return (isReadOnly ? 0 : 1) + ";";
}, function (_ref2) {
  var isReadOnly = _ref2.isReadOnly;
...
var defaultProps = {
  src: '',
  annotations: [],
  editorMode: exports.EditorMode.AnnotateWithText,
...
var Img = /*#__PURE__*/styled__default.img(_templateObject$7 || (_templateObject$7 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  display: block;\n  width: 100%;\n"])));
...
var ToolbarDiv = /*#__PURE__*/styled__default.div(_templateObject$8 || (_templateObject$8 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  border: 1px solid #ccc;\n  background-color: #efefef;\n  width: 100%;\n  display: flex;\n"])));
var StyledIcon = /*#__PURE__*/styled__default.a(_templateObject2$2 || (_templateObject2$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  border-right: 1px solid #ccc;\n  width: 40px;\n  height: 40px;\n  background-repeat: no-repeat;\n  background-position: center;\n  cursor: pointer;\n  background-color: ", ";\n"])), function (_ref) {
  var isSelected = _ref.isSelected;
  return isSelected ? '#ccc' : '#efefef';
});
var CircleIcon = /*#__PURE__*/styled__default(StyledIcon)(_templateObject3 || (_templateObject3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background-image: url(", ");\n"])), CircleSvg);
var PointIcon = /*#__PURE__*/styled__default(StyledIcon)(_templateObject4 || (_templateObject4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background-image: url(", ");\n"])), PointSvg);
var SquareIcon = /*#__PURE__*/styled__default(StyledIcon)(_templateObject5 || (_templateObject5 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background-image: url(", ");\n"])), SquareSvg);
var BackIcon = /*#__PURE__*/styled__default(StyledIcon)(_templateObject6 || (_templateObject6 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background-image: url(", ");\n"])), BackSvg);
var TrashIcon = /*#__PURE__*/styled__default(StyledIcon)(_templateObject7 || (_templateObject7 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background-image: url(", ");\n"])), TrashSvg);
function ToolBar(_ref2) {
  ...
  })) : React__default.createElement(React__default.Fragment, null, allowedShapes.includes(exports.AllowedShape.Rectangle) ? React__default.createElement(SquareIcon, {
    isSelected: selectedSelectorType === exports.AllowedShape.Rectangle,
    onClick: function onClick() {
      return setSelectedSelectorType(exports.AllowedShape.Rectangle);
    }
  }) : null, allowedShapes.includes(exports.AllowedShape.Oval) ? React__default.createElement(CircleIcon, {
    isSelected: selectedSelectorType === exports.AllowedShape.Oval,
    onClick: function onClick() {
      return setSelectedSelectorType(exports.AllowedShape.Oval);
    }
  }) : null, allowedShapes.includes(exports.AllowedShape.Point) ? React__default.createElement(PointIcon, {
    isSelected: selectedSelectorType === exports.AllowedShape.Point,
    onClick: function onClick() {
      return setSelectedSelectorType(exports.AllowedShape.Point);
    }
  }) : null)) : null;
}
...
var ItemsDiv = /*#__PURE__*/styled__default.div(_templateObject2$3 || (_templateObject2$3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n"])));
var ReadOnlyDiv = /*#__PURE__*/styled__default.div(_templateObject3$1 || (_templateObject3$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n"])));
...
function Annotation(options) {
  ...
  var _useState = React.useState(props.allowedShapes[0]),
  ...
  var _useState4 = React.useState(options.annotations),
  ...
  var isInEditMode = editorMode !== exports.EditorMode.ReadOnly && editorMode !== exports.EditorMode.ReadOnlyWithSelection;
  React.useEffect(function () {
    if (isInEditMode) {
      {
    ...
    if (!!options[methodName]) {
      ...
      if (selectorMethod) {
        ...
        switch (value == null ? void 0 : (_value$selection = value.selection) == null ? void 0 : _value$selection.mode) {
          case exports.SelectionMode.Final:
            onAnnotationFinal(value);
            setShowEditor(true);
            break;

          case exports.SelectionMode.Editing:
            setShowEditor(true);
            break;
  ...
  var onAnnotationClick = React.useCallback(function (annotation) {
  ...
  }), showEditor && tmpAnnotation && ((_tmpAnnotation$select = tmpAnnotation.selection) == null ? void 0 : _tmpAnnotation$select.mode) === exports.SelectionMode.Editing && renderEditor({
    annotation: tmpAnnotation,
...
exports.Annotation = WrappedAnnotation;
exports.Oval = Oval$1;
exports.OvalSelector = OvalSelector;
...
//# sourceMappingURL=react-mark-image.cjs.development.js.map
